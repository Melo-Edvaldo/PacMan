...
pygame.display.set_caption("Pac Man - Aula 30")
...
class Cenario(ElementoJogo):
    ...
    def adicionar_movivel(self, objetivo):
        self.moviveis.append(objetivo)
    ...
    def pintar_vitoria(self, tela):
        self.pintar_texto_centro(tela, "PARABÉNS, VOCÊ VENCEU!!!")
